...
def accuracy(y_true, y_pred):
    """
    Calculates the accuracy of a classification model given the true and
    predicted labels.
...
def precision(y_true, y_pred):
    """
    Calculates the precision of a classification model given the true and
    predicted labels.
...
def recall(y_true, y_pred):
    """
    Calculates the recall of a classification model given the true and
    predicted labels.
...
def f1(y_true, y_pred):
    """
    Calculates the f1 score of a classification model given the true and
    predicted labels.
...
def confusion_matrix(y_true, y_pred):
    """
    Calculates the confusion matrix of a classification model given the true
