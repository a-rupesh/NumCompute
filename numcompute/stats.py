...
class StreamingStats:
    ...
    def update(self, x):
        ...
        Exceptions Raised:
            TypeError: If x is not of type np.ndarray
            TypeError: If axis is not None or of type int
            ValueError: If x contains NaNs.
            ValueError: If axis is not None and does not satisfy -arr.ndim <= axis < arr.ndim
            ValueError: If x is not of the same dimension as arrays previous passed into update()
            ValueError: If x is not the same shape in the non-axis dimensions as 
                        arrays previously passed into update()
        
        Time Complexity: O(N) where N is the total number of elements in x
        Space Complexity: O(N) where N is the total number of elements in x
        """
        ...
        if self.axis != None:
            if not isinstance(self.axis, int):
                raise TypeError("Axis must be None of or type int")
...
def mean(arr, axis = None):
    ...
    Exceptions Raised:
        TypeError: If arr is not of type np.ndarray
        TypeError: If axis is not None or type int
        ValueError: If axis is not None and does not satisfy -arr.ndim <= axis < arr.ndim

    Time Complexity: O(N) where N is the total number of elements along the given axis
    Spacee Complexity: O(M) where M is the total number of elements in the array
    """
...
def median(arr, axis = None):
    ...
    Time Complexity: O(N) where N is the total number of elements along the given axis
    Space Complexity: O(M) where M is the total number of elements in the array
    """
...
def std(arr, axis = None):
    ...
    Time Complexity: O(N) where N is total number of elements along given axis
    Space Complexity: O(M) where M is the total number of elements in the array
    """
...
def min(arr, axis = None):
    ...
    Time Complexity: O(N) where N is the total number of elements along given axis
    Space Complexity: O(M) where M is the total number of elements in the array
    """
...
def histogram(arr, bins, range = None):
    ...
    Time Complexity: O(M + B) where M is the total number of elements in the array 
...
def quantile(arr, q, axis = None):
    ...
    Time Complexity: O(N) where N is the total number of elements over the given axis
    Space Complexity: O(M) where M is the total number of elements in the array
    """
